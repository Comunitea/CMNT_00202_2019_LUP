 ...
 */
odoo.define('custom_lupeon.CustomInfoWidget', function (require) {
    "use strict";
    ...
    ListRenderer.include({
        ...
        _renderBodyCell: function (record, node) {
            ...
            if (node.tag === 'widget' && node.attrs.name === 'custom_info_widget') {
    ...
    var CustomInfoWidget = Widget.extend({
        template: 'custom_lupeon.customInfoWidget',
        ...
        //--------------------------------------------------------------------------
        /**
         * Set a bootstrap popover on the current customInfoWidget widget that display available
         * quantity.
         */
        _setPopOver: function () {
            ...
            var $content = $(QWeb.render('custom_lupeon.CustomInfoPopOver', {
                data: this.data,
            }));
            var options = {
                content: $content,
    ...
    widget_registry.add('custom_info_widget', CustomInfoWidget);
